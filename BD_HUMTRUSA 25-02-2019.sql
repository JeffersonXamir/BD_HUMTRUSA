...
insert  into `cabecera_venta`(`id`,`num_venta`,`fecha_creacion`,`id_usuario`,`id_empresa`,`tipo_pago`,`tipo_venta`,`subtotal_con_iva`,`subtotal_sin_iva`,`iva_total`,`descuento_total`,`total`) values (5,'000001','2019-02-25 02:02:54',2,1,'contado','factura',8.00000,8.00000,2.00000,1.00000,16.00000);
...
insert  into `detalle_venta`(`id`,`id_cabecera_venta`,`id_producto`,`precio`,`cantidad`,`iva`,`descuento`) values (2,5,1,30.00000,2,2.00000,1.00000);
